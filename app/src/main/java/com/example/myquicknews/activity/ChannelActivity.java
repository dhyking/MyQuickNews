...
import com.example.myquicknews.AppApplication;
...
import com.example.myquicknews.adapter.OtherAdapter;
import com.example.myquicknews.model.ChannelItem;
import com.example.myquicknews.model.ChannelManage;
import com.example.myquicknews.view.DragGridView;
import com.example.myquicknews.view.MoreGridView;
...
public class ChannelActivity extends DragActivity implements AdapterView.OnItemClickListener {
    /** 用户栏目的GRIDVIEW */
    private DragGridView userGridView;
    /** 其它栏目的GRIDVIEW */
    private MoreGridView otherGridView;
    /** 用户栏目对应的适配器，可以拖动 */
    ...
    private void initData() {
        ...
        Log.d("ChannelActivity", "userChannelList.size():" + userChannelList.size());
        Log.d("ChannelActivity", "otherChannelList.size():" + otherChannelList.size());

        userAdapter = new DragAdapter(this, userChannelList);
        Log.d("ChannelActivity", "userAdapter.getCount():" + userAdapter.getCount());
    ...
    private void initView() {
        ...
        otherGridView = (MoreGridView) findViewById(R.id.otherGridView);
    }
            ...
            case R.id.userGridView:
                ...
                if (position != 0 && position != 1) {
                    ...
                    if (moveImageView != null) {
                        TextView newTextView = (TextView) view.findViewById(R.id.tv_category_name);
                        ...
                        new Handler().postDelayed(new Runnable() {
                            public void run() {
                                try {
                                    ...
                                    userAdapter.setRemovePosition(position);
    ...
    public void finish() {
        if (userAdapter.isListChanged()) {
            saveChannel();
            Intent mIntent = new Intent(ChannelActivity.this, MainActivity.class);
            setResult(1,mIntent);
        }
        super.finish();
    }
